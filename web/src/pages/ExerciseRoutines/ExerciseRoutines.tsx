...
const ExerciseRoutines: React.FC<ExerciseRoutinesProps> = ({ isDarkMode }) => {
  ...
  if (isLoading) {
    return (
      <div
        className={`flex flex-col items-center justify-center h-screen ${isDarkMode ? 'bg-dark-bg text-gray-100' : 'bg-gray-50 text-gray-800'}`}
      >
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-8 lg:px-8">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="text-sm text-white">
                    For best results, complete at least 3 workouts per week and maintain proper
                    form.
                  </p>
                </div>
                <button
        ...
        <motion.div
          ...
          animate="visible"
        >
          <h2 className="text-xl font-semibold p-5 border-b border-gray-200 dark:border-gray-700">
            Available Exercises
          </h2>
