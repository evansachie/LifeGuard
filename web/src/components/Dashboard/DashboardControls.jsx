...
const DashboardControls = forwardRef(function DashboardControls(
  {
    isDarkMode,
    onSearchChange,
    onViewChange,
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (isFilterMenuOpen && !event.target.closest('.filter-container')) {
        setIsFilterMenuOpen(false);
      }
            ...
            <div className="dropdown-menu filter-menu" role="menu">
              ...
              <div className="filter-option">
                <input
                  ...
                  onChange={handleFilterOptionChange}
                />
                <div className={`${isDarkMode ? 'text-white' : 'text-black'}`} htmlFor="airQuality">
                  Air Quality
                </div>
              </div>
              <div className="filter-option">
                <input
                  ...
                  onChange={handleFilterOptionChange}
                />
                <div className={`${isDarkMode ? 'text-white' : 'text-black'}`} htmlFor="alerts">
                  Alerts
                </div>
              </div>
            </div>
          ...
          {isSortMenuOpen && (
            <div className="dropdown-menu sort-menu" role="menu">
              <div className="sort-option">
                ...
                />
                <div className={`${isDarkMode ? 'text-white' : 'text-black'}`} htmlFor="newest">
                  Newest First
                </div>
              </div>
              <div className="sort-option">
                <input
                  ...
                  onChange={handleSortOptionChange}
                />
                <div className={`${isDarkMode ? 'text-white' : 'text-black'}`} htmlFor="oldest">
                  Oldest First
                </div>
              </div>
              <div className="sort-option">
                <input
                  ...
                  onChange={handleSortOptionChange}
                />
                <div className={`${isDarkMode ? 'text-white' : 'text-black'}`} htmlFor="priority">
                  Priority
                </div>
              </div>
            </div>
