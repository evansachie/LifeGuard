  ...
  const getRecommendations = (): string[] => {
    ...
    if (goal === 'lose') {
      recommendations.push(
        'Focus on a calorie deficit of 500-750 calories per day for sustainable weight loss.'
      );
      ...
      recommendations.push(
        'Aim for a calorie surplus of 300-500 calories per day for lean muscle gain.'
      );
      recommendations.push(
        'Focus on progressive overload in your strength training to stimulate muscle growth.'
      );
      recommendations.push(
        'Consider splitting your protein intake across 4-5 meals throughout the day.'
      );
    } else {
    ...
    if (activityLevel === 'sedentary') {
      ...
      recommendations.push(
        'Consider starting with short walks or gentle exercises to build consistency.'
      );
    } else if (activityLevel === 'veryActive') {
      recommendations.push(
        'Ensure adequate recovery between intense workouts to prevent overtraining.'
      );
      recommendations.push(
        'Consider including electrolyte replenishment for longer training sessions.'
      );
    }
