      ...
      >
        ...
        <div className={`${compact ? 'p-3' : 'p-4'} flex-grow flex flex-col`}>
          <div className="flex justify-between items-start mb-2">
            <h3
              className={`${compact ? 'text-base' : 'text-lg'} font-semibold ${isDarkMode ? 'text-white' : 'text-gray-800'}`}
            >
              {exercise.title}
            </h3>
          ...
          {!compact && (
            <p
              className={`text-sm mb-4 flex-grow ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}
            >
          ...
          <div className="flex justify-between items-center mb-3">
            <span
              className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-medium ${isDarkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700'}`}
            >
