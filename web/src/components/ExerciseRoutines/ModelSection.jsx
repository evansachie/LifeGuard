  ...
  return (
    <>
      <div className="h-full flex flex-col">
        <div className={`${isDarkMode ? 'bg-dark-card2' : 'bg-gray-100'} text-${isDarkMode ? 'white' : 'gray-800'} p-3 flex justify-between items-center`}>
          <div className="flex items-center gap-2">
            <FaInfoCircle className={`${isDarkMode ? 'text-white/80' : 'text-gray-600'}`} />
            <h3 className="font-semibold">
              {activeExercise 
                ? `Muscles: ${activeExercise.title}` 
        ...
        {highlightedMuscles.length > 0 && (
          <div className={`p-3 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'} border-t ${isDarkMode ? 'border-gray-600' : 'border-gray-200'}`}>
      ...
      <AnimatePresence>
        {isFullscreen && (
          <div className="fixed inset-0 z-50">
            ...
            >
              <div className={`w-full h-full flex flex-col overflow-hidden rounded-xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-2xl`}>
                <div className={`${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} text-${isDarkMode ? 'white' : 'gray-800'} p-4 flex justify-between items-center border-b ${isDarkMode ? 'border-gray-700' : 'border-gray-200'}`}>
