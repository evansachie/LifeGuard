...
GENERATE_PROMPT = (
    ...
    "If you need context to answer the question AND THERE'S NO CONTEXT, ask the user to upload the health-report."
    "for instance, if the user asks 'What's my weight?', if you don't have context, encourage the user to upload a health report.Don't answer"
