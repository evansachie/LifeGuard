 ...
 */
// Generated on: 16.06.2025 10:18:10
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data1[20*33] = { 
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data2[20] = { 2, 402, -182, -83, -183, 81, 11, -56, 172, -78, 145, 212, -156, -83, 185, 412, -75, -39, 5, -155, };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data3[10*20] = { 
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int32_t tensor_data4[10] = { -515, 0, 91, 344, 984, 1043, -346, -573, 33, -335, };
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(16) int8_t tensor_data5[3*10] = { 
...
const MODEL_SECTION(EI_MODEL_SECTION) ALIGN(8) int32_t tensor_data6[3] = { -126, -207, 275, };
...
{ kTfLiteMmapRo, kTfLiteInt8, (int32_t*)g0::tensor_data1, (TfLiteIntArray*)&g0::tensor_dimension1, 660, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&g0::quant1))}, },
...
{ kTfLiteMmapRo, kTfLiteInt8, (int32_t*)g0::tensor_data5, (TfLiteIntArray*)&g0::tensor_dimension5, 30, {kTfLiteAffineQuantization, const_cast<void*>(static_cast<const void*>(&g0::quant5))}, },
