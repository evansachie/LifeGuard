...
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_46_axes[] = { 0, 1, 2 };
...
ei_model_dsp_t ei_dsp_blocks[ei_dsp_blocks_size] = {
    { // DSP block 46
        ...
        (void*)&ei_dsp_config_46, // pointer to config struct
        ei_dsp_config_46_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_46_axes_size, // number of axes
        1, // version
...
const uint32_t ei_learning_block_10_inputs[1] = { 46 };
...
const ei_impulse_t impulse_657930_0 = {
    .project_id = 657930,
    .project_owner = "Michael  Adu-Gyamfi",
    .project_name = "LifeGuard",
    .impulse_id = 1,
    .impulse_name = "Time series data, Spectral Analysis, Classification",
    .deploy_version = 19,
...
ei_impulse_handle_t impulse_handle_657930_0 = ei_impulse_handle_t( &impulse_657930_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_657930_0;
